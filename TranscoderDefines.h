...
#if !defined(TranscoderDefines_H)
#define	TranscoderDefines_H
...
const uint8_t  DMR_NXDN_DATA_HEADER[] = { MARKER, 0x0DU, 0x00U, TYPE_DATA };
const uint16_t DMR_NXDN_DATA_LEN      = DMR_NXDN_DATA_LENGTH + DATA_HEADER_LEN;
