...
bool CNXDNFACCH1::decode(const uint8_t* data, unsigned int offset)
{
	assert(data != nullptr);
...
void CNXDNFACCH1::encode(uint8_t* data, unsigned int offset) const
{
	assert(data != nullptr);
...
void CNXDNFACCH1::getData(uint8_t* data) const
{
	assert(data != nullptr);
...
void CNXDNFACCH1::getRaw(uint8_t* data) const
{
	assert(data != nullptr);
...
void CNXDNFACCH1::setData(const uint8_t* data)
{
	assert(data != nullptr);
...
void CNXDNFACCH1::setRaw(const uint8_t* data)
{
	assert(data != nullptr);
