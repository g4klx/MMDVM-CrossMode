...
OBJECTS =	BPTC19696.o CRC.o Conf.o CrossMode.o Data.o DMRLookup.o DMRLC.o DMRNetwork.o DStarNetwork.o FMNetwork.o Golay24128.o Hamming.o \
			Log.o M17Network.o Network.o NXDNConvolution.o NXDNCRC.o NXDNFACCH1.o NXDNLayer3.o NXDNLICH.o NXDNLookup.o NXDNNetwork.o \
			P25Network.o RS129.o StopWatch.o Thread.o Timer.o Transcoder.o UARTController.o UDPSocket.o Utils.o YSFConvolution.o YSFFICH.o \
